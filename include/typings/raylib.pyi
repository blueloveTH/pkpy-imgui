...
class Mesh:
    ...
    boneIds: intptr # Vertex bone ids, max 255 bone ids, up to 4 bones influence by vertex (skinning) (unsigned char *)
    boneWeights: intptr # Vertex bone weight, up to 4 bones influence by vertex (skinning) (float *)
    ...
    def __init__(self): ...
    @overload
    def __init__(self, vertexCount: int, triangleCount: int, vertices: intptr, texcoords: intptr, texcoords2: intptr, normals: intptr, tangents: intptr, colors: intptr, indices: intptr, animVertices: intptr, animNormals: intptr, boneIds: intptr, boneWeights: intptr, vaoId: int, vboId: intptr): ...
    def __address__(self) -> int: ...
    def copy(self) -> 'Mesh': ...
...
class Ray:
    ...
    direction: vec3 # Ray direction (Vector3)
...
def WaveCrop(wave: intptr, initSample: int, finalSample: int) -> None:
