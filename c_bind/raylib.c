...
static bool Mesh__init__(int argc, py_Ref argv) {
    ...
    if(argc == 1) {
        ...
        self->vaoId = py_toint(py_arg(14));
        if(!py_checkint(py_arg(15))) return false;
        self->vboId = (unsigned int *)py_toint(py_arg(15));
    } else {
        return TypeError("expected 1 or 16 arguments");
    }
    py_newnone(py_retval());
    return true;
}
...
static bool cfunc__IsShaderReady(int argc, py_Ref argv) {
    Shader _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_Shader)) return false;
        _0 = *(Shader*)py_touserdata(py_arg(0));
    } while(0);
    bool res = IsShaderReady(_0);
    py_newbool(py_retval(), res);
    return true;
}
...
static bool cfunc__DrawRectangleRoundedLines(int argc, py_Ref argv) {
    ...
    DrawRectangleRoundedLines(_0, _1, _2, _3, _4);
    py_newnone(py_retval());
    return true;
}
...
static bool cfunc__LoadImageSvg(int argc, py_Ref argv) {
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    int _1;
    ...
    if(!py_checkint(py_arg(2))) return false;
    _2 = py_toint(py_arg(2));
    Image res = LoadImageSvg(_0, _1, _2);
    do {
        Image* ud = py_newobject(py_retval(), tp_user_Image, 0, sizeof(Image));
        *ud = res;
    } while(0);
...
static bool cfunc__IsImageReady(int argc, py_Ref argv) {
    Image _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_Image)) return false;
        _0 = *(Image*)py_touserdata(py_arg(0));
    } while(0);
    bool res = IsImageReady(_0);
    py_newbool(py_retval(), res);
    return true;
}
...
static bool cfunc__IsTextureReady(int argc, py_Ref argv) {
    Texture2D _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_Texture2D)) return false;
        _0 = *(Texture2D*)py_touserdata(py_arg(0));
    } while(0);
    bool res = IsTextureReady(_0);
    py_newbool(py_retval(), res);
    return true;
}
...
static bool cfunc__IsRenderTextureReady(int argc, py_Ref argv) {
    RenderTexture2D _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_RenderTexture2D)) return false;
        _0 = *(RenderTexture2D*)py_touserdata(py_arg(0));
    } while(0);
    bool res = IsRenderTextureReady(_0);
    py_newbool(py_retval(), res);
    return true;
}
...
static bool cfunc__IsFontReady(int argc, py_Ref argv) {
    Font _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_Font)) return false;
        _0 = *(Font*)py_touserdata(py_arg(0));
    } while(0);
    bool res = IsFontReady(_0);
    py_newbool(py_retval(), res);
    return true;
}
...
static bool cfunc__IsSoundReady(int argc, py_Ref argv) {
    Sound _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_Sound)) return false;
        _0 = *(Sound*)py_touserdata(py_arg(0));
    } while(0);
    bool res = IsSoundReady(_0);
    py_newbool(py_retval(), res);
    return true;
}
...
void py__add_module_raylib() {
    ...
    py_bindfunc(mod, "IsShaderReady", &cfunc__IsShaderReady);
    ...
    py_bindfunc(mod, "LoadImageSvg", &cfunc__LoadImageSvg);
    ...
    py_bindfunc(mod, "IsImageReady", &cfunc__IsImageReady);
    ...
    py_bindfunc(mod, "IsTextureReady", &cfunc__IsTextureReady);
    py_bindfunc(mod, "UnloadTexture", &cfunc__UnloadTexture);
    py_bindfunc(mod, "IsRenderTextureReady", &cfunc__IsRenderTextureReady);
    ...
    py_bindfunc(mod, "IsFontReady", &cfunc__IsFontReady);
    ...
    py_bindfunc(mod, "IsModelReady", &cfunc__IsModelReady);
    ...
    py_bindfunc(mod, "IsMaterialReady", &cfunc__IsMaterialReady);
    ...
    py_bindfunc(mod, "IsWaveReady", &cfunc__IsWaveReady);
    ...
    py_bindfunc(mod, "IsSoundReady", &cfunc__IsSoundReady);
    ...
    py_bindfunc(mod, "IsMusicReady", &cfunc__IsMusicReady);
    ...
    py_bindfunc(mod, "IsAudioStreamReady", &cfunc__IsAudioStreamReady);
    ...
    ADD_ENUM(CUBEMAP_LAYOUT_PANORAMA);
